...
{
{text = '✭ سورس القيصر ✭', url = 't.me/COURSE_CAESAR '},
},
{
{text = '✭ مطور الصانع ✭', url = 't.me/c_a_s_e_r_h '},
},
}
...
local UserId_Info = LuaTele.searchPublicChat("c_a_s_e_r_h")
...
local TestText = "*✯ مبرمج سورس قيصر ✭\n✯ ɴᴀᴍᴇ  >* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*✯ ʙɪᴏ -> "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/c_a_s_e_r_h"}
},
}
...
local T =[[
☆︙[𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝑆𝑂𝑈𝑅𝐶𝐸 𝐂𝐀𝐄𝐒𝐀𝐑](t.me/COURSE_CAESAR )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/c_a_s_e_r_h '},
},
{
{text = '• تنصيب بوت مدفوع •', url = 't.me/c_a_s_e_r_h'},
},
{
{text = '• قناة التحديثات •', url = 't.me/COURSE_CAESAR '},
},
{  
